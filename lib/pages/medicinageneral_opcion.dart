...
class MedicinaGeneralOpcion extends StatefulWidget {
  static const routeName = 'medicinageneralopcion';
  const MedicinaGeneralOpcion({Key? key}) : super(key: key);

  @override
  _MedicinaGeneralOpcionState createState() => _MedicinaGeneralOpcionState();
}

class _MedicinaGeneralOpcionState extends State<MedicinaGeneralOpcion> {
  @override
                ...
                child: Form(
                  child: Column(
                    children: <Widget>[
                      ElevatedButton(
                        onPressed: () {
                          Navigator.pushNamed(context, 'dismedicina');
                        },
                ...
                child: Form(
                  child: Column(
                    children: <Widget>[
                      ElevatedButton(
                        onPressed: () {
                          Navigator.pushNamed(context, 'fichamedicinageneral');
                        },
