...
class CardiologiaOpcion extends StatefulWidget {
  static const routeName = 'cardiologiaopcion';
  const CardiologiaOpcion({Key? key}) : super(key: key);

  @override
  _CardiologiaOpcionState createState() => _CardiologiaOpcionState();
}

class _CardiologiaOpcionState extends State<CardiologiaOpcion> {
  @override
                ...
                child: Form(
                  child: Column(
                    children: <Widget>[
                      ElevatedButton(
                        onPressed: () {
                          Navigator.pushNamed(context, 'discardiologia');
                        },
                ...
                child: Form(
                  child: Column(
                    children: <Widget>[
                      ElevatedButton(
                        onPressed: () {
                          Navigator.pushNamed(context, 'fichacardiologia');
                        },
