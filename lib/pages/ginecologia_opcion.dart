...
class GinecologiaOpcion extends StatefulWidget {
  static const routeName = 'ginecologiaopcion';
  const GinecologiaOpcion({Key? key}) : super(key: key);

  @override
  _GinecologiaOpcionState createState() => _GinecologiaOpcionState();
}

class _GinecologiaOpcionState extends State<GinecologiaOpcion> {
  @override
                ...
                child: Form(
                  child: Column(
                    children: <Widget>[
                      ElevatedButton(
                        onPressed: () {
                          Navigator.pushNamed(context, 'disginecologia');
                        },
                ...
                child: Form(
                  child: Column(
                    children: <Widget>[
                      ElevatedButton(
                        onPressed: () {
                          Navigator.pushNamed(context, 'fichaginecologia');
                        },
