import 'package:appregister/API/autenticacion_cardiologia.dart';
...
class FichaCardiologiaForm extends StatefulWidget {
  const FichaCardiologiaForm({Key? key}) : super(key: key);

  @override
  _FichaCardiologiaFormState createState() => _FichaCardiologiaFormState();
}

class _FichaCardiologiaFormState extends State<FichaCardiologiaForm> {
  // ignore: prefer_final_fields, unused_field
  GlobalKey<FormState> _formkey = GlobalKey();
  final AutenticacionCardiologia _autenticacionCardiologia =
      AutenticacionCardiologia();
  ...
  _submit() {
    ...
    if (isOk) {
      _autenticacionCardiologia.register(
        nombre: usuario1,
        apellido: apellido1,
        fecha: fecha,
        hora: hora,
